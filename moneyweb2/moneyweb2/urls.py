...
from webapp.views import login, details_yewu,browse_yewu,register, insert_yewu,update,update_search,main,login_error, search,logout,inset_people,browse_people
